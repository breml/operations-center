...
func Test_GetWithFilterNetworks(t *testing.T) {
	d := daemonSetup(t)
	...
	tests := []struct {
		...
		assertFunc func(t *testing.T, result []api.Network)
	}{
		{
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := tc.client.GetWithFilterNetworks(t.Context(), inventory.NetworkFilter{})
...
func Test_GetNetwork(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := tc.client.GetNetwork(t.Context(), tc.tcNameArg)
...
// Test_ResyncNetwork only covers the error paths, which are
// handled before the Incus API of the cluster is contacted.
func Test_ResyncNetwork(t *testing.T) {
	d := daemonSetup(t)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			err := tc.client.ResyncNetwork(t.Context(), tc.tcNameArg)
