...
func Test_GetWithFilterNetworkAddressSets(t *testing.T) {
	d := daemonSetup(t)
	...
	tests := []struct {
		...
		assertFunc func(t *testing.T, result []api.NetworkAddressSet)
	}{
		{
		...
		},
		{
			...
			dbSeedFunc: func(t *testing.T) {
				...
				_, err = entities.CreateNetworkAddressSet(t.Context(), d.db, inventory.NetworkAddressSet{
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := tc.client.GetWithFilterNetworkAddressSets(t.Context(), inventory.NetworkAddressSetFilter{})
...
func Test_GetNetworkAddressSet(t *testing.T) {
	d := daemonSetup(t)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := tc.client.GetNetworkAddressSet(t.Context(), tc.tcNameArg)
...
// Test_ResyncNetworkAddressSet only covers the error paths, which are
// handled before the Incus API of the cluster is contacted.
func Test_ResyncNetworkAddressSet(t *testing.T) {
	d := daemonSetup(t)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			err := tc.client.ResyncNetworkAddressSet(t.Context(), tc.tcNameArg)
