...
func Test_GetWithFilterNetworkPeers(t *testing.T) {
	d := daemonSetup(t)
	...
	tests := []struct {
		...
		assertFunc func(t *testing.T, result []api.NetworkPeer)
	}{
		{
		...
		},
		{
			...
			dbSeedFunc: func(t *testing.T) {
				...
				_, err = entities.CreateNetworkPeer(t.Context(), d.db, inventory.NetworkPeer{
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := tc.client.GetWithFilterNetworkPeers(t.Context(), inventory.NetworkPeerFilter{})
...
func Test_GetNetworkPeer(t *testing.T) {
	d := daemonSetup(t)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := tc.client.GetNetworkPeer(t.Context(), tc.tcNameArg)
...
// Test_ResyncNetworkPeer only covers the error paths, which are
// handled before the Incus API of the cluster is contacted.
func Test_ResyncNetworkPeer(t *testing.T) {
	d := daemonSetup(t)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			err := tc.client.ResyncNetworkPeer(t.Context(), tc.tcNameArg)
