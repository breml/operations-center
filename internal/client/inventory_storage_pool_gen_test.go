...
func Test_GetWithFilterStoragePools(t *testing.T) {
	d := daemonSetup(t)
	...
	tests := []struct {
		...
		assertFunc func(t *testing.T, result []api.StoragePool)
	}{
		{
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := tc.client.GetWithFilterStoragePools(t.Context(), inventory.StoragePoolFilter{})
...
func Test_GetStoragePool(t *testing.T) {
	d := daemonSetup(t)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := tc.client.GetStoragePool(t.Context(), tc.tcNameArg)
...
// Test_ResyncStoragePool only covers the error paths, which are
// handled before the Incus API of the cluster is contacted.
func Test_ResyncStoragePool(t *testing.T) {
	d := daemonSetup(t)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			err := tc.client.ResyncStoragePool(t.Context(), tc.tcNameArg)
