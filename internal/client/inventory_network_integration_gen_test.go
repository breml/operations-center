...
func Test_GetWithFilterNetworkIntegrations(t *testing.T) {
	...
	tests := []struct {
		...
		assertFunc func(t *testing.T, result []api.NetworkIntegration)
	}{
		{
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := tc.client.GetWithFilterNetworkIntegrations(t.Context(), inventory.NetworkIntegrationFilter{})
...
func Test_GetNetworkIntegration(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := tc.client.GetNetworkIntegration(t.Context(), tc.tcNameArg)
...
// Test_ResyncNetworkIntegration only covers the error paths, which are
// handled before the Incus API of the cluster is contacted.
func Test_ResyncNetworkIntegration(t *testing.T) {
	d := daemonSetup(t)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			err := tc.client.ResyncNetworkIntegration(t.Context(), tc.tcNameArg)
