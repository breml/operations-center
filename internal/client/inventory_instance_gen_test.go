...
func Test_GetWithFilterInstances(t *testing.T) {
	d := daemonSetup(t)
	...
	tests := []struct {
		...
		assertFunc func(t *testing.T, result []api.Instance)
	}{
		{
		...
		},
		{
			...
			dbSeedFunc: func(t *testing.T) {
				...
				_, err = entities.CreateInstance(t.Context(), d.db, inventory.Instance{
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := tc.client.GetWithFilterInstances(t.Context(), inventory.InstanceFilter{})
...
func Test_GetInstance(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := tc.client.GetInstance(t.Context(), tc.tcNameArg)
...
// Test_ResyncInstance only covers the error paths, which are
// handled before the Incus API of the cluster is contacted.
func Test_ResyncInstance(t *testing.T) {
	d := daemonSetup(t)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			err := tc.client.ResyncInstance(t.Context(), tc.tcNameArg)
