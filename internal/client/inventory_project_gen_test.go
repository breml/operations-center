...
func Test_GetWithFilterProjects(t *testing.T) {
	d := daemonSetup(t)
	...
	tests := []struct {
		...
		assertFunc func(t *testing.T, result []api.Project)
	}{
		{
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := tc.client.GetWithFilterProjects(t.Context(), inventory.ProjectFilter{})
...
func Test_GetProject(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := tc.client.GetProject(t.Context(), tc.tcNameArg)
...
// Test_ResyncProject only covers the error paths, which are
// handled before the Incus API of the cluster is contacted.
func Test_ResyncProject(t *testing.T) {
	d := daemonSetup(t)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			err := tc.client.ResyncProject(t.Context(), tc.tcNameArg)
