...
func Test_GetWithFilterNetworkZones(t *testing.T) {
	d := daemonSetup(t)
	...
	tests := []struct {
		...
		assertFunc func(t *testing.T, result []api.NetworkZone)
	}{
		{
		...
		},
		{
			...
			dbSeedFunc: func(t *testing.T) {
				...
				_, err = entities.CreateNetworkZone(t.Context(), d.db, inventory.NetworkZone{
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := tc.client.GetWithFilterNetworkZones(t.Context(), inventory.NetworkZoneFilter{})
...
func Test_GetNetworkZone(t *testing.T) {
	d := daemonSetup(t)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := tc.client.GetNetworkZone(t.Context(), tc.tcNameArg)
...
// Test_ResyncNetworkZone only covers the error paths, which are
// handled before the Incus API of the cluster is contacted.
func Test_ResyncNetworkZone(t *testing.T) {
	d := daemonSetup(t)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			err := tc.client.ResyncNetworkZone(t.Context(), tc.tcNameArg)
