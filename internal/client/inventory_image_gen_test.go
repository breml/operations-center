...
func Test_GetWithFilterImages(t *testing.T) {
	d := daemonSetup(t)
	...
	tests := []struct {
		...
		assertFunc func(t *testing.T, result []api.Image)
	}{
		{
		...
		},
		{
			...
			dbSeedFunc: func(t *testing.T) {
				...
				_, err = entities.CreateImage(t.Context(), d.db, inventory.Image{
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := tc.client.GetWithFilterImages(t.Context(), inventory.ImageFilter{})
...
func Test_GetImage(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := tc.client.GetImage(t.Context(), tc.tcNameArg)
...
// Test_ResyncImage only covers the error paths, which are
// handled before the Incus API of the cluster is contacted.
func Test_ResyncImage(t *testing.T) {
	d := daemonSetup(t)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			err := tc.client.ResyncImage(t.Context(), tc.tcNameArg)
