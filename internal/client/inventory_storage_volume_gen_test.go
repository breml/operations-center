...
func Test_GetWithFilterStorageVolumes(t *testing.T) {
	d := daemonSetup(t)
	...
	tests := []struct {
		...
		assertFunc func(t *testing.T, result []api.StorageVolume)
	}{
		{
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := tc.client.GetWithFilterStorageVolumes(t.Context(), inventory.StorageVolumeFilter{})
...
func Test_GetStorageVolume(t *testing.T) {
	d := daemonSetup(t)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := tc.client.GetStorageVolume(t.Context(), tc.tcNameArg)
